...
import 'package:video_player_app/features/video-player-app/model/album_model.dart';
...
class AlbumDetailScreen extends StatefulWidget {
  AlbumTabModel album;
  AlbumDetailScreen({required this.album, super.key});
        ...
        children: [
          ...
          Center(
            child: Column(
              children: [
                ...
                RegularText(
                  text: widget.album.songsList.length.toString() + " Songs",
          ...
          Expanded(child:
            ...
            return ListView.builder(
                itemCount: widget.album.songsList.length,
                itemBuilder: ((context, index) {
                  print("songs : ${value.songs.first}");
                  return SongsRowWidget(
                      song: widget.album.songsList[index],
                      songName: widget.album.songsList[index].title,
                      subtitle: widget.album.songsList[index].displayName,
