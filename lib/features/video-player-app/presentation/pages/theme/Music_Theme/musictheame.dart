...
class ThemeOrangeMusicPlayer extends StatefulWidget {
  final List<SongModel>? songs;

  final int? currentindex;
  final Function(int)? updatedIndex;
  const ThemeOrangeMusicPlayer({
    Key? key,
    this.songs,
    this.currentindex,
    this.updatedIndex,
  ...
  @override
  State<ThemeOrangeMusicPlayer> createState() => _ThemeOrangeMusicPlayerState();
}

class _ThemeOrangeMusicPlayerState extends State<ThemeOrangeMusicPlayer> {
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                image: QueryArtworkWidget(
                        ...
                        null
                    ? DecorationImage(
                        image: AssetImage(AppImages.artist2), fit: BoxFit.cover)
                    : null,
              ),
                  ...
                  child: ValueListenableBuilder(
                      ...
                      builder: (context, value, child) {
                        return GestureDetector(
                          ...
                          child: Icon(
                            isPlayer.value ? Icons.pause : Icons.play_arrow,
